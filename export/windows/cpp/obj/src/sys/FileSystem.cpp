...
{
		HX_STACK_PUSH("FileSystem::createDirectory","C:\\HaxeToolkit\\haxe/std/cpp/_std/sys/FileSystem.hx",69);
		...
		struct _Function_1_1{
			inline static Array< ::String > Block( ::String &path1){
				HX_STACK_PUSH("*::closure","C:\\HaxeToolkit\\haxe/std/cpp/_std/sys/FileSystem.hx",71);
				{
					HX_STACK_LINE(71)
...
{
		HX_STACK_PUSH("FileSystem::deleteFile","C:\\HaxeToolkit\\haxe/std/cpp/_std/sys/FileSystem.hx",79);
		HX_STACK_ARG(path,"path");
		HX_STACK_LINE(79)
