...
int Stdin_obj::writeBytes( ::haxe::io::Bytes buf,int pos,int len){
	HX_STACK_PUSH("Stdin::writeBytes","C:\\HaxeToolkit\\haxe/std/cpp/_std/sys/io/Process.hx",44);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Stdin::writeByte","C:\\HaxeToolkit\\haxe/std/cpp/_std/sys/io/Process.hx",39);
		HX_STACK_THIS(this);
		HX_STACK_ARG(c,"c");
		HX_STACK_LINE(40)
		this->buf->b[(int)0] = c;
...
{
		HX_STACK_PUSH("Stdin::close","C:\\HaxeToolkit\\haxe/std/cpp/_std/sys/io/Process.hx",34);
		HX_STACK_THIS(this);
		HX_STACK_LINE(35)
		this->super::close();
		HX_STACK_LINE(36)
