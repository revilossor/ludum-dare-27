...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(34)
		::flash::Lib_obj::setPackage(HX_CSTRING("Zaphod"),HX_CSTRING("LD27"),HX_CSTRING("com.example.myapp"),HX_CSTRING("0.0.1"));
