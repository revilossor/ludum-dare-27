...
{
		HX_STACK_PUSH("Output::writeString","C:\\HaxeToolkit\\haxe/std/haxe/io/Output.hx",313);
		HX_STACK_THIS(this);
		HX_STACK_ARG(s,"s");
		HX_STACK_LINE(317)
...
{
		HX_STACK_PUSH("Output::writeFullBytes","C:\\HaxeToolkit\\haxe/std/haxe/io/Output.hx",89);
		HX_STACK_THIS(this);
		HX_STACK_ARG(s,"s");
...
{
		HX_STACK_PUSH("Output::close","C:\\HaxeToolkit\\haxe/std/haxe/io/Output.hx",68);
		HX_STACK_THIS(this);
	}
return null();
}
...
int Output_obj::writeBytes( ::haxe::io::Bytes s,int pos,int len){
	HX_STACK_PUSH("Output::writeBytes","C:\\HaxeToolkit\\haxe/std/haxe/io/Output.hx",42);
	HX_STACK_THIS(this);
	HX_STACK_ARG(s,"s");
	HX_STACK_ARG(pos,"pos");
	HX_STACK_ARG(len,"len");
...
{
		HX_STACK_PUSH("Output::writeByte","C:\\HaxeToolkit\\haxe/std/haxe/io/Output.hx",38);
		HX_STACK_THIS(this);
		HX_STACK_ARG(c,"c");
		HX_STACK_LINE(38)
