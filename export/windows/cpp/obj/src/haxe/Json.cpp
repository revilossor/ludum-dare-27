...
{
HX_STACK_PUSH("Json::new","C:\\HaxeToolkit\\haxe/std/haxe/Json.hx",39);
{
}
;
	return null();
...
{
		HX_STACK_PUSH("Json::invalidNumber","C:\\HaxeToolkit\\haxe/std/haxe/Json.hx",354);
		HX_STACK_THIS(this);
...
::String Json_obj::parseString( ){
	HX_STACK_PUSH("Json::parseString","C:\\HaxeToolkit\\haxe/std/haxe/Json.hx",293);
	HX_STACK_THIS(this);
	HX_STACK_LINE(294)
...
Dynamic Json_obj::parseRec( ){
	HX_STACK_PUSH("Json::parseRec","C:\\HaxeToolkit\\haxe/std/haxe/Json.hx",211);
	HX_STACK_THIS(this);
	HX_STACK_LINE(211)
	while((true)){
		HX_STACK_LINE(213)
			...
			case (int)123: {
				struct _Function_3_1{
					inline static Dynamic Block( ){
						HX_STACK_PUSH("*::closure","C:\\HaxeToolkit\\haxe/std/haxe/Json.hx",218);
						{
			...
			case (int)48: case (int)49: case (int)50: case (int)51: case (int)52: case (int)53: case (int)54: case (int)55: case (int)56: case (int)57: case (int)45: {
				struct _Function_3_1{
					inline static Float Block( int &c,::haxe::Json_obj *__this){
						HX_STACK_PUSH("*::closure","C:\\HaxeToolkit\\haxe/std/haxe/Json.hx",286);
						{
							HX_STACK_LINE(286)
...
{
		HX_STACK_PUSH("Json::invalidChar","C:\\HaxeToolkit\\haxe/std/haxe/Json.hx",202);
		HX_STACK_THIS(this);
		HX_STACK_LINE(203)
		(this->pos)--;
		HX_STACK_LINE(204)
...
Dynamic Json_obj::doParse( ::String str){
	HX_STACK_PUSH("Json::doParse","C:\\HaxeToolkit\\haxe/std/haxe/Json.hx",196);
	HX_STACK_THIS(this);
...
Dynamic Json_obj::parse( ::String text){
	HX_STACK_PUSH("Json::parse","C:\\HaxeToolkit\\haxe/std/haxe/Json.hx",398);
